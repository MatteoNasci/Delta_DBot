...
mln::cache<uint64_t, dpp::guild, false, 400, 30, 0.7, true> mln::caches::guild_cache{};
mln::cache<uint64_t, dpp::channel, false, 2500, 300, 0.7, true> mln::caches::channel_cache{};
