...
dpp::task<void> mln::mog::mog_help::command(const dpp::slashcommand_t& event_data, mog_cmd_data_t& cmd_data, const mog_command_type) const
{
...
mln::mog::mog_init_type_flag mln::mog::mog_help::get_requested_initialization_type(const mog_command_type cmd) const
{
