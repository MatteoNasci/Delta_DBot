...
namespace mln {
    ...
    private:
        size_t saved_insert_stmt, saved_insert_replace_stmt, saved_select_stmt, saved_show_records_stmt, saved_update_stmt, saved_update_desc_stmt, saved_remove_stmt;
