...
namespace mln {
	...
	protected:
		base_guild_create(dpp::cluster& cluster) noexcept;
	public:

		base_guild_create() = delete;
		base_guild_create(const base_guild_create& rhs) noexcept;
		base_guild_create(base_guild_create&& rhs) noexcept;
		base_guild_create& operator=(const base_guild_create& rhs) noexcept;
		base_guild_create& operator=(base_guild_create&& rhs) noexcept;
	};
}
